...
# Draws a circle and moves to random position within the screen and repeats it
# If the turtle goes out of the screen, it resets its position to a random position within the screen
...
def randomwalk():
    ...
    for _ in range(REPETITION):
        ...
        # drawing the circle
        turtly.circle(random.randint(1, 50))
