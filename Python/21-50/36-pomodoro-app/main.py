...
# for counting the number of times the user has completed a session
reps = 1
timer = None

# tomato image file directory
TOMATO_FILE_DIR = r"learning-programming\Python\21-50\36-pomodoro-app\tomato.png"
...
try:
    ...
    print("Tomato image file not found")
