...
# Ans: A. Can be solved by removing extra value. For e.g., a[::2]=10,20,30,40,50
...
# a[3:0:-1] = [4, 3, 2];    a[3] = 4, a[2] = 3, a[1] = 2, up to a[1] is sliced
# a[4:2:-1] = [5, 4];       a[4] = 5, a[3] = 4, up to index 3 is sliced
